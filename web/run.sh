...
sudo sed -i '0,/.*session.save_path.*/s/.*session.save_path.*/session.save_path = "tcp:'\\/''\\/'localhost:6379?database=12"/' /etc/php/7.4/apache2/php.ini
...
sudo -Hu www-data /var/www/MISP/app/Console/cake Admin setSetting "MISP.python_bin" "/var/www/MISP/venv/bin/python"
sudo -Hu www-data /var/www/MISP/app/Console/cake userInit -q
sudo -Hu www-data /var/www/MISP/app/Console/cake live 1
#sudo chown www-data:www-data /var/www/MISP/app/Config/config.php*
#
# Start supervisord
